...
if (!isset($_GET['field']) || !isset($_GET['nurse_id'])) {
...
$sql = "SELECT $field FROM nurses WHERE ID = $nurse_id";
...
if ($result->num_rows > 0) {
    ...
    die("Няма данни за медицинската сестра!");
}
...
<body>
    <div class="container">
        ...
        <form method="POST" action="update_nurse_admin.php">
