...
if (!isset($_POST['nurse_id']) || !isset($_POST['field']) || !isset($_POST['field_value'])) {
...
$sql = "UPDATE nurses SET $field = ? WHERE ID = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param('si', $field_value, $nurse_id);
...
<body>
    <div class="container">
        ...
        <?php endif; ?>
        <div class="back-link"><a href="menu_nurse_admin.php?nurse_id=<?php echo htmlspecialchars($nurse_id); ?>">Върни се назад</a></div>
    </div>
</body>
