<?php
session_start();
if (!isset($_POST['administrator_id']) || !isset($_POST['field']) || !isset($_POST['field_value'])) {
    die("Invalid request");
}
...
$sql = "UPDATE administrators SET $field = ? WHERE ID = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param('si', $field_value, $administrator_id);
...
<div class="container">
        ...
        <?php endif; ?>
        <div class="back-link"><a href="menu_administrator.php">Върни се назад</a></div>
    </div>
