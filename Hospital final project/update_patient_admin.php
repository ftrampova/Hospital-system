...
$allowedFields = ["Name", "Phone", "Address", "DateOfBirth", "Gender", "Disease", "TreatingDoctorID", "Treatment", "TreatmentDays", "RoomNumber", "Email", "Password", "Operation", "DepartmentId", "RoomType"];
...
<body>
    <div class="container">
        ...
        <?php endif; ?>
        <div class="back-link"><a href="menu_patient_admin.php?patient_id=<?php echo htmlspecialchars($patient_id); ?>">Върни се назад</a></div>
    </div>
</body>
