...
if (!isset($_GET['field']) || !isset($_GET['maintenance_id'])) {
...
$sql = "SELECT $field FROM maintenance WHERE ID = $maintenance_id";
...
<body>
    <div class="container">
        ...
        <form method="POST" action="update_maintenance_admin.php">
            ...
            <input type="text" id="<?php echo htmlspecialchars($field); ?>" name="field_value" value="<?php echo htmlspecialchars($fieldValue); ?>" required>
